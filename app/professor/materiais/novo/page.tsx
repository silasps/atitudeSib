...
import { Upload, Link as LinkIcon, FileText, Image } from "lucide-react";
...
export default function NovoMaterialPage() {
  ...
  const [tipo, setTipo] = useState<"link" | "imagem" | "pdf">("link");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const materialData = {
        ...
        visibilidade: "turmas_selecionadas",
      };
      ...
      for (const turmaId of selectedTurmas) {
        ...
        if (error) {
          setMessage(`Erro ao salvar material: ${error.message}`);
          setSaving(false);
          return;
        }
      }
      ...
      setMessage("Erro inesperado ao salvar material.");
      setSaving(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-bold text-zinc-900">Novo material</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          >
            {saving ? "Criando material..." : "Criar material"}
          </button>
          <Link
            href="/professor/materiais"
